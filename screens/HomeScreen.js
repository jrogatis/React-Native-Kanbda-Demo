...
import TalkDetailsScreen from '../screens/TalkDetailsScreen';
...
_onRowPressed(rowData) {
    let route = {
      name: 'TalkDetailsScreen',
      title: 'Talk Details',
      talk: rowData
    }; 
    const Router = createRouter(() => ({
          TalkDetailsScreen: () => TalkDetailsScreen
         }));     

      this.props.navigator.push(Router.getRoute('TalkDetailsScreen', route));     
